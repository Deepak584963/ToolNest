...
export default function ThemeToggle() {
  ...
  // The button shell is always the same; only the icon internals change.
  const showDark = mounted ? isDark : false;
  const showSystemBadge = mounted && theme === "system";
  ...
  return (
    <button
      ...
      aria-label={mounted ? `Theme: ${label}. Click to change.` : "Toggle theme"}
      title={mounted ? `Theme: ${label}` : "Toggle theme"}
