...
const toolProfiles: Record<string, ToolProfile> = {
  ...
  "regex-tester-replacer": {
    purpose: "This regex tool helps developers build, test, and debug regular expressions with immediate match feedback and replacement previews.",
    ...
    bestFor: "text parsing, log cleanup, data validation, and QA automation prep.",
    workflow: ["Enter pattern and toggle flags.", "Paste test text and inspect matches.", "Apply replacement expression.", "Copy output or match JSON for tooling."],
    examples: ["Validating email patterns in form inputs.", "Extracting IDs from logs.", "Replacing sensitive values before sharing logs."],
    mistakes: ["Forgetting global flag when counting all matches.", "Using greedy quantifiers unintentionally.", "Testing against tiny samples that hide edge cases."],
    faqs: [
      { question: "Does this support capture groups?", answer: "Yes. JavaScript regular expression behavior applies." },
      { question: "Can I test multiline text?", answer: "Yes. Use the `m` and `s` flags where appropriate." },
      { question: "Are patterns executed server-side?", answer: "No. Everything runs in your browser." },
    ],
    related: ["text-cleaner", "json-formatter-validator", "base64-encoder-decoder"],
  },
  "jwt-decoder-inspector": {
    purpose: "This inspector decodes JWT header and payload sections to help debug authentication flows without exposing tokens to external servers.",
    ...
    workflow: ["Paste JWT token.", "Decode header and payload.", "Review claims like exp, nbf, iat.", "Copy payload JSON for issue reports."],
    examples: ["Checking why a token appears expired.", "Confirming expected audience and issuer claims.", "Comparing dev vs production token structures."],
    mistakes: ["Assuming decode equals signature verification.", "Sharing sensitive tokens publicly.", "Ignoring clock skew in expiry checks."],
    faqs: [
      { question: "Does this verify signature?", answer: "No. It decodes token data only." },
      { question: "Is my token uploaded?", answer: "No. Processing stays local in the browser." },
      { question: "Can this handle malformed tokens?", answer: "It reports parse errors when token segments are invalid." },
    ],
    related: ["base64-encoder-decoder", "json-formatter-validator", "password-strength-checker"],
  },
  "cron-expression-builder": {
    purpose: "This builder creates cron expressions with presets and human-readable summaries so teams can define schedules faster and with fewer syntax errors.",
    inputs: "Minute, hour, day, month, weekday fields plus optional command and timezone notes.",
    outputs: "Cron expression, crontab line, and schedule summary.",
    bestFor: "DevOps routines, background jobs, automation tasks, and maintenance scripts.",
    workflow: ["Fill cron fields or choose a preset.", "Validate expression format instantly.", "Attach command and timezone context.", "Copy expression or export `.cron` file."],
    examples: ["Running cache cleanup every hour.", "Scheduling weekday digest jobs.", "Setting monthly billing tasks."],
    mistakes: ["Swapping day-of-month and day-of-week fields.", "Forgetting timezone assumptions.", "Using broad wildcards for expensive jobs."],
    faqs: [
      { question: "Is this Linux cron format?", answer: "Yes, it targets standard 5-field cron format." },
      { question: "Can I save schedules?", answer: "You can download expressions as a `.cron` file." },
      { question: "Does it run jobs?", answer: "No. It generates schedule strings for your systems." },
    ],
    related: ["uuid-generator", "json-formatter-validator", "text-cleaner"],
  },
  "sql-formatter-beautifier": {
    purpose: "This SQL utility formats and minifies query text to improve readability during debugging and reduce noise in tooling workflows.",
    inputs: "Raw SQL query text and formatting preferences.",
    outputs: "Beautified SQL and minified SQL variants.",
    bestFor: "database debugging, query review, migration scripts, and API query payload cleanup.",
    workflow: ["Paste SQL query.", "Adjust indentation and keyword style.", "Review formatted and minified outputs.", "Copy or download preferred version."],
    examples: ["Cleaning ORM-generated SQL for debugging.", "Preparing query snippets for documentation.", "Compressing SQL for transport-heavy tooling."],
    mistakes: ["Treating formatter output as SQL syntax validation.", "Ignoring DB-specific dialect quirks.", "Minifying queries before debugging readability issues."],
    faqs: [
      { question: "Does it execute SQL?", answer: "No. It only transforms query text." },
      { question: "Can it fix invalid SQL?", answer: "It improves formatting but does not guarantee syntax correctness." },
      { question: "Is this dialect-specific?", answer: "It works for common SQL patterns and is useful for many dialects." },
    ],
    related: ["json-formatter-validator", "css-minifier-beautifier", "text-cleaner"],
  },
  "http-status-code-lookup": {
    purpose: "This lookup tool helps developers quickly find HTTP status code meanings and choose accurate API responses.",
    ...
    bestFor: "REST API design, backend error handling, and API documentation writing.",
    workflow: ["Search by code or message.", "Filter by response category.", "Review usage context.", "Copy/download sample response payload."],
    examples: ["Choosing between 400 and 422 for validation failures.", "Documenting 429 rate-limit responses.", "Standardizing error payload structure across services."],
    mistakes: ["Returning 200 for failing operations.", "Using 500 for client-caused errors.", "Inconsistent status usage across endpoints."],
    faqs: [
      { question: "Does this include all HTTP codes?", answer: "It focuses on the most-used API and web status codes." },
      { question: "Can I copy a response template?", answer: "Yes. The tool generates ready-to-copy JSON examples." },
      { question: "Is this tied to a framework?", answer: "No. It is framework-agnostic." },
    ],
    related: ["json-formatter-validator", "jwt-decoder-inspector", "regex-tester-replacer"],
  },
  ...
  "schema-markup-generator": {
    ...
    inputs: "Schema type, title, description, URL, image, and optional type-specific fields like offers or FAQ pairs.",
    outputs: "Copy-ready JSON-LD script block for direct placement in page head or templates.",
    bestFor: "technical SEO implementation, rich result preparation, and launch QA for content and product pages.",
    workflow: [
    ...
    faqs: [
      { question: "Does schema guarantee rich results?", answer: "No. It improves eligibility, but search engines decide final display." },
      { question: "Should schema match on-page content?", answer: "Yes. Structured data should reflect what users can see on the page." },
      { question: "Can I use multiple schema types on one page?", answer: "Yes when they are valid and contextually relevant." },
    ],
    related: ["meta-title-description-preview", "open-graph-social-preview", "canonical-url-checker"],
  },
  "hreflang-tag-generator": {
    ...
    outputs: "HTML alternate link tags and sitemap-compatible hreflang fragment.",
    bestFor: "multilingual websites, regional landing pages, and international SEO setups.",
    workflow: [
    ...
    faqs: [
      { question: "Do hreflang tags improve ranking directly?", answer: "They mainly improve correct regional/language targeting and reduce mismatch issues." },
      { question: "Should I include x-default?", answer: "Usually yes for a global fallback page." },
      { question: "Can I place hreflang in sitemap instead of HTML?", answer: "Yes. Either method works when implemented correctly." },
    ],
    related: ["canonical-url-checker", "sitemap-xml-generator", "robots-txt-generator"],
  },
  "redirect-rule-generator": {
    ...
    inputs: "Old-to-new URL path pairs, preferred domain, and redirect status (301/302).",
    outputs: "Apache, Nginx, and Netlify redirect rule sets.",
    bestFor: "site migrations, URL cleanup projects, and content restructuring.",
    workflow: [
    ...
    faqs: [
      { question: "When should I use 301 vs 302?", answer: "Use 301 for permanent moves and 302 for temporary rerouting." },
      { question: "Are redirects enough for migrations?", answer: "Also update canonicals, sitemaps, and internal links." },
      { question: "Should old URLs remain in sitemap?", answer: "No. Sitemaps should list only final canonical URLs." },
    ],
    related: ["canonical-url-checker", "sitemap-xml-generator", "robots-txt-generator"],
  },
  "robots-meta-tag-generator": {
    ...
    inputs: "Index/follow toggles and advanced directives like max-snippet, max-image-preview, and max-video-preview.",
    outputs: "Meta robots tag and X-Robots-Tag header strings.",
    bestFor: "technical SEO controls for sensitive pages, faceted navigation, and preview governance.",
    workflow: [
    ...
    faqs: [
      { question: "Does noindex stop crawling?", answer: "Not always. It primarily controls indexing, not crawl eligibility." },
      { question: "When use X-Robots-Tag?", answer: "Useful for non-HTML files or server-side directive control." },
      { question: "Can robots tags be overridden?", answer: "Conflicts can happen; keep directives consistent across layers." },
    ],
    related: ["robots-txt-generator", "meta-title-description-preview", "canonical-url-checker"],
  },
  "keyword-cluster-generator": {
    ...
    inputs: "One keyword per line plus optional brand and target audience context.",
    outputs: "Keyword clusters with intent labels, suggested SEO title, H1, and CSV export.",
    bestFor: "content strategy planning, topic map creation, and SEO editorial workflows.",
    workflow: [
    ...
    faqs: [
      { question: "Is this replacement for full keyword research?", answer: "No. It organizes keywords after research, then accelerates planning." },
      { question: "How many keywords can I cluster?", answer: "Use practical browser-sized lists for best performance." },
      { question: "Can clusters support programmatic SEO?", answer: "Yes when combined with quality templates and strong content QA." },
    ],
    related: ["keyword-density-checker", "text-to-url-slug-generator", "meta-title-description-preview"],
  },
  ...
  "youtube-chapter-timestamp-generator": {
    purpose: "This tool auto-generates clean YouTube chapter timestamps from your topic outline and video length, helping improve watch navigation and retention.",
    inputs: "Total video duration, topic list, optional intro/outro durations, and chapter naming style.",
    outputs: "Copy-ready chapter timestamp lines for YouTube descriptions.",
    bestFor: "YouTubers publishing tutorials, breakdowns, interviews, and long-form educational videos.",
    workflow: ["Enter total duration and section topics.", "Set intro/outro timings if needed.", "Generate chapter list.", "Copy or download and paste into YouTube description."],
    examples: ["Generating chapters for a 12-minute coding tutorial.", "Splitting a podcast into key discussion segments.", "Adding navigation points to improve viewer experience."],
    mistakes: ["Using too many tiny chapters.", "Forgetting to include 00:00 start chapter.", "Mismatching chapter labels with actual sequence."],
    faqs: [
      { question: "Why use chapters on YouTube?", answer: "Chapters improve navigation and can increase watch-time quality by helping viewers jump to relevant parts." },
      { question: "Do chapters help SEO?", answer: "They can improve discoverability by clarifying topic structure for users and platforms." },
      { question: "What format should timestamps follow?", answer: "Use `00:00 Title` style, one chapter per line in your description." },
    ],
    related: ["youtube-description-template-generator", "youtube-title-analyzer", "video-length-estimator"],
  },
  "engagement-rate-calculator": {
    purpose: "This calculator helps creators evaluate post performance by computing engagement rate across follower, reach, and view-based formulas.",
    inputs: "Likes, comments, shares, saves, follower count, reach, and views.",
    outputs: "Engagement totals plus ER by followers/reach/views and a simple performance band.",
    bestFor: "creators, social media managers, brand partnerships, and campaign reporting.",
    workflow: ["Enter post interaction metrics.", "Add account/reach/view counts.", "Review ER variants.", "Use insights to compare posts and optimize future content."],
    examples: ["Comparing Reel vs carousel engagement quality.", "Preparing sponsor report with ER by reach.", "Tracking monthly performance baseline."],
    mistakes: ["Comparing ER across unrelated formats without context.", "Ignoring saves/shares in quality analysis.", "Using only follower-based ER for short-form videos."],
    faqs: [
      { question: "Which ER metric is best?", answer: "ER by reach is often most reliable for content performance comparison." },
      { question: "What is a good engagement rate?", answer: "It depends on niche and platform, but higher than your historical baseline is a strong signal." },
      { question: "Can this be used for sponsor decks?", answer: "Yes, it helps present consistent performance metrics." },
    ],
    related: ["best-time-to-post-planner", "viral-content-calendar-generator", "caption-generator"],
  },
  "viral-content-calendar-generator": {
    purpose: "This planner builds a monthly posting schedule with strategic pillar rotation, helping creators stay consistent and avoid idea fatigue.",
    inputs: "Month/year, posts per week, platform, and content pillars.",
    outputs: "Structured content calendar rows with date, pillar, angle, and format.",
    bestFor: "creators planning weekly output across Instagram, YouTube, LinkedIn, or X.",
    workflow: ["Choose month, year, and post frequency.", "Define your core content pillars.", "Generate calendar plan.", "Export CSV and plug into workflow tools."],
    examples: ["Creating a 4-post/week Instagram month.", "Planning educational and conversion posts in balance.", "Preparing a YouTube monthly publishing system."],
    mistakes: ["Overloading one pillar repeatedly.", "Ignoring platform format distribution.", "Not scheduling follow-up CTA posts."],
    faqs: [
      { question: "Can I export the plan?", answer: "Yes, export as CSV and import into your planner or spreadsheet." },
      { question: "How many pillars should I use?", answer: "Usually 3-5 pillars keeps variety while maintaining brand focus." },
      { question: "Should I post daily?", answer: "Consistency beats volume. Use a cadence you can sustain." },
    ],
    related: ["content-idea-generator", "best-time-to-post-planner", "hook-generator-for-reels"],
  },
  "best-time-to-post-planner": {
    purpose: "This planner suggests practical posting windows by combining platform peak patterns with timezone and audience region distribution.",
    inputs: "Platform selection, timezone offset, and audience region share mix.",
    ...
    workflow: ["Select platform and timezone.", "Enter audience region percentages.", "Generate posting windows.", "Test and iterate based on analytics."],
    examples: ["Optimizing Instagram posting for India + US audience.", "Scheduling LinkedIn posts for workday windows.", "Testing YouTube publish slots for watch-time growth."],
    mistakes: ["Using generic timing without checking audience location.", "Changing times too frequently to compare outcomes.", "Ignoring platform-specific behavior differences."],
    faqs: [
      { question: "Are these exact guaranteed times?", answer: "No, they are planning windows. Validate with your own analytics." },
      { question: "How often should I adjust timing?", answer: "Review every 2-4 weeks using engagement and reach trends." },
      { question: "Can this help small accounts?", answer: "Yes, timing discipline helps early growth and experimentation." },
    ],
    related: ["engagement-rate-calculator", "viral-content-calendar-generator", "caption-generator"],
  },
  "utm-link-builder-for-creators": {
    purpose: "This builder creates campaign-tagged URLs so creators can track performance of links shared in bios, posts, stories, and newsletters.",
    inputs: "Target URL and UTM fields: source, medium, campaign, term, and content.",
    outputs: "Final UTM-tagged URL ready for analytics tracking.",
    bestFor: "creators, affiliate marketers, and growth teams measuring conversion sources.",
    workflow: ["Paste destination URL.", "Fill campaign parameters.", "Generate tracking link.", "Copy, deploy, and analyze in analytics tools."],
    examples: ["Tracking link clicks from Instagram bio.", "Measuring story vs post conversion performance.", "Comparing campaign creatives via utm_content."],
    mistakes: ["Inconsistent naming conventions across campaigns.", "Forgetting lowercase standardization.", "Using ambiguous campaign names."],
    faqs: [
      { question: "Do UTM links affect SEO?", answer: "Use canonical handling properly; UTM is mainly for tracking, not ranking manipulation." },
      { question: "Which fields are mandatory?", answer: "Source, medium, and campaign are the core minimum fields." },
      { question: "Where can I view results?", answer: "In your analytics platform under campaign/source reports." },
    ],
    related: ["engagement-rate-calculator", "best-time-to-post-planner", "content-idea-generator"],
  },
  // ──────────────── IMAGE TOOL PROFILES ────────────────
  ...
  "webp-to-png-converter": {
    purpose: "This converter transforms WebP images into PNG format for workflows that need wide compatibility and lossless editing.",
    inputs: "A WebP image file.",
    outputs: "PNG output ready for download.",
    bestFor: "designers, developers, and content teams handling mixed image format requirements.",
    workflow: ["Upload a WebP file.", "Run conversion.", "Preview output.", "Download PNG."],
    examples: ["Converting modern web assets for legacy design tools.", "Preparing WebP graphics for print workflows.", "Sharing a WebP image where PNG is required."],
    mistakes: ["Using PNG when file size needs to stay very low.", "Ignoring output dimensions before publishing.", "Converting repeatedly and losing workflow consistency."],
    faqs: [
      { question: "Will quality drop?", answer: "No additional quality loss is added when exporting to PNG from decoded source pixels." },
      { question: "Does PNG support transparency?", answer: "Yes. Transparency is preserved if present in the source." },
      { question: "Are files uploaded?", answer: "No. Processing is local in your browser." },
    ],
    related: ["png-to-webp-converter", "jpg-to-png-converter", "compress-image"],
  },
  "png-to-webp-converter": {
    purpose: "This converter turns PNG images into WebP to reduce file size while keeping strong visual quality.",
    ...
    examples: ["Shrinking hero banner files.", "Optimizing e-commerce product images.", "Reducing content delivery payloads."],
    mistakes: ["Using very low quality and introducing artifacts.", "Forgetting to keep source originals.", "Not testing browser compatibility for old environments."],
    faqs: [
      { question: "How much smaller can WebP be?", answer: "Often 25-70% smaller depending on the image and quality target." },
      { question: "Can WebP keep transparency?", answer: "Yes. WebP supports alpha transparency." },
      { question: "Is this suitable for SEO?", answer: "Yes. Smaller images generally improve load speed and user experience." },
    ],
    related: ["webp-to-png-converter", "compress-image", "resize-image"],
  },
  "image-cropper": {
    purpose: "This cropper trims images with precise coordinates so you can isolate the exact area you need.",
    ...
    workflow: ["Upload image.", "Set crop box values.", "Run crop.", "Download output."],
    examples: ["Cropping profile photos to square.", "Cutting UI screenshots for docs.", "Removing unwanted edges from scans."],
    mistakes: ["Setting crop area outside image bounds.", "Cropping too small for final use.", "Skipping preview checks before download."],
    faqs: [
      { question: "Can I crop transparent images?", answer: "Yes, PNG output preserves transparency where available." },
      { question: "Does it resize too?", answer: "No, it crops the selected region at selected output size." },
      { question: "Is it exact-pixel based?", answer: "Yes, all crop values are pixel based." },
    ],
    related: ["resize-image", "image-rotate-flip-tool", "compress-image"],
  },
  "image-rotate-flip-tool": {
    purpose: "This tool rotates and mirrors images to quickly fix orientation issues.",
    ...
    workflow: ["Upload image.", "Choose rotation/flip.", "Apply transformation.", "Download result."],
    examples: ["Correcting camera orientation.", "Mirroring product mockups.", "Flipping screenshots for layout tests."],
    mistakes: ["Applying multiple transforms without checking orientation.", "Using wrong rotation direction.", "Replacing originals without backup."],
    faqs: [
      { question: "Does it reduce quality?", answer: "Output is regenerated via canvas and remains suitable for most workflows." },
      { question: "Can I combine rotate and flip?", answer: "Yes, both can be applied in one operation." },
      { question: "Is it local-only?", answer: "Yes, no server upload is used." },
    ],
    related: ["image-cropper", "resize-image", "image-watermark-tool"],
  },
  "image-watermark-tool": {
    purpose: "This watermark tool overlays text branding on images to protect ownership and identify source.",
    inputs: "Image file, watermark text, opacity, size, and position.",
    outputs: "Watermarked PNG image.",
    bestFor: "content creators, photographers, and agencies sharing proofs online.",
    workflow: ["Upload image.", "Customize watermark settings.", "Apply watermark.", "Download protected image."],
    examples: ["Adding brand URL to social images.", "Creating proof images for clients.", "Marking draft assets for internal review."],
    mistakes: ["Using low contrast watermark text.", "Placing watermark over critical content.", "Using full opacity and harming readability."],
    faqs: [
      { question: "Can watermark text be moved?", answer: "Yes, choose from common position presets." },
      { question: "Is this reversible?", answer: "No practical automatic reversal exists after export." },
      { question: "Should I keep originals?", answer: "Always keep an unwatermarked master copy." },
    ],
    related: ["image-to-pdf-converter", "image-cropper", "image-rotate-flip-tool"],
  },
  "image-color-palette-extractor": {
    purpose: "This extractor analyzes uploaded images and returns dominant colors for design and branding use.",
    inputs: "An image file.",
    outputs: "Top dominant hex color palette.",
    bestFor: "UI designers, brand teams, and content creators matching visual themes.",
    workflow: ["Upload image.", "Run palette extraction.", "Review top colors.", "Copy hex values."],
    examples: ["Building a page palette from a hero image.", "Matching ad creatives to brand colors.", "Extracting tones from product photography."],
    mistakes: ["Relying on one image for full brand system decisions.", "Ignoring accessibility contrast checks.", "Using highly compressed sources for palette decisions."],
    faqs: [
      { question: "How many colors are extracted?", answer: "The tool returns a focused dominant set for practical usage." },
      { question: "Can I copy hex codes?", answer: "Yes, click a swatch to copy." },
      { question: "Is this accurate enough for design?", answer: "Yes for rapid drafting and moodboards." },
    ],
    related: ["image-collage-maker", "image-watermark-tool", "favicon-generator"],
  },
  "image-collage-maker": {
    purpose: "This collage maker combines multiple images into one layout for quick sharing and presentations.",
    ...
    workflow: ["Upload up to 4 images.", "Generate collage.", "Preview layout.", "Download final collage."],
    examples: ["Creating before/after showcase grids.", "Combining event photos into one post.", "Preparing one-image reports for chat or docs."],
    mistakes: ["Using mismatched aspect ratios without planning.", "Overcrowding with too many detailed images.", "Skipping quality checks on mobile view."],
    faqs: [
      { question: "Can I add more than 4 images?", answer: "Current layout supports up to 4 for clear composition." },
      { question: "Is spacing customizable?", answer: "This version uses a clean fixed grid for speed." },
      { question: "Does it upload files?", answer: "No, all processing is browser-local." },
    ],
    related: ["image-to-pdf-converter", "resize-image", "image-cropper"],
  },
  "image-blur-tool": {
    purpose: "This tool applies a controllable blur effect to images for visual styling or privacy masking.",
    inputs: "Image file and blur radius value.",
    outputs: "Blurred PNG image.",
    bestFor: "background styling, privacy obfuscation, and visual focus effects.",
    workflow: ["Upload image.", "Set blur amount.", "Apply effect.", "Download output."],
    examples: ["Blurring backgrounds for profile graphics.", "Masking sensitive text in screenshots.", "Creating soft hero overlays."],
    mistakes: ["Using blur as a sole redaction method for strict security workflows.", "Overblurring and losing useful context.", "Forgetting to keep original copy."],
    faqs: [
      { question: "Can blur be reversed?", answer: "Not reliably once exported." },
      { question: "Is this suitable for redaction?", answer: "For critical redaction, use full masking/blocking, not blur alone." },
      { question: "Does quality remain high?", answer: "Yes, output remains suitable for most publishing uses." },
    ],
    related: ["image-watermark-tool", "rounded-corners-image-tool", "compress-image"],
  },
  "rounded-corners-image-tool": {
    purpose: "This tool clips image corners to a configurable radius and exports clean PNG assets for UI and social design.",
    ...
    workflow: ["Upload image.", "Choose corner radius.", "Apply effect.", "Download PNG."],
    examples: ["Creating card thumbnails.", "Rounding profile asset corners.", "Preparing design-system style previews."],
    mistakes: ["Using a radius too large for image dimensions.", "Exporting as JPG and losing transparency.", "Ignoring how corner styles fit surrounding UI."],
    faqs: [
      { question: "Why PNG output?", answer: "PNG preserves transparent corner areas." },
      { question: "Can I use this for avatars?", answer: "Yes, it works well for rounded avatar assets." },
      { question: "Is radius pixel-based?", answer: "Yes, radius control is in pixels." },
    ],
    related: ["image-cropper", "resize-image", "favicon-generator"],
  },
  "image-to-ascii-art": {
    purpose: "This creative tool converts image brightness values into text characters to generate ASCII art.",
    ...
    workflow: ["Upload an image.", "Adjust width and character set.", "Generate ASCII output.", "Copy or save text."],
    examples: ["Creating terminal profile banners.", "Building retro project art.", "Making text previews for docs."],
    mistakes: ["Using very small widths for detailed images.", "Choosing character sets with poor tonal range.", "Expecting photo-realistic output from ASCII."],
    faqs: [
      { question: "Can I customize the character ramp?", answer: "Yes, you can provide your own character set." },
      { question: "Why does aspect look stretched?", answer: "ASCII characters have non-square proportions; width/height compensation is applied." },
      { question: "Can I copy output quickly?", answer: "Yes, use the built-in copy button." },
    ],
    related: ["base64-image-encoder", "image-color-palette-extractor", "image-collage-maker"],
  },
